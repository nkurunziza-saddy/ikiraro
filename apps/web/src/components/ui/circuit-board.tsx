...
function CircuitBoard({
  ...
  const computedPulseColor =
    pulseColor || (isDark ? "rgba(163, 163, 163, 0.6)" : "rgba(64, 64, 64, 0.7)");
        ...
        return (
          ...
          >
            <motion.div
              ...
              animate={
                node.status === "processing" ? { opacity: [0.2, 0.5, 0.2] } : { opacity: 0.2 }
              }
            ...
            {node.label && (
              <div
                className="absolute -bottom-6 start-1/2 -translate-x-1/2 rtl:translate-x-1/2 whitespace-nowrap text-xs font-medium"
