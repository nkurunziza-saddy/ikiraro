 ...
 * Paths are designed to be recognizable at sizes from 40px to 300px.
 * Decisions: Single-color silhouette, palm-forward orientation, no outlines.
 */

// Paths are in a 100×120 viewBox. Palm base y=90-115, fingertips y=5-30. Thumb left.
const HAND_PATHS: Record<string, string> = {
  ...
  L: "M36,112 C30,112 26,108 26,98 L26,72 C26,62 30,56 36,54 L36,52 C36,52 40,50 40,54 L40,54 C44,56 48,58 50,62 L50,68 C54,66 58,66 60,68 L60,72 L60,98 C60,108 56,112 52,112 Z M32,54 L34,10 C34,4 38,2 42,2 C46,2 48,4 48,10 L46,54 Z M26,68 L4,56 C-2,52 -4,44 2,40 C6,38 12,40 16,46 L26,58 Z",
